...
class GetStatementByPeriodFailureTest extends BaseClientTestCase
{
    ...
    public function test(
        ...
        try {
            $this->client->getStatementByPeriod(new GetStatementByPeriodRequest(new DateTime('2025-07-25 13:00:00')));
