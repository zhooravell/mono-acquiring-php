...
class CreatePaymentByCardCredentialsSuccessTest extends BaseClientTestCase
{
...
JSON;
        ...
        $result = $this->client->createPaymentByCardCredentials(new CreatePaymentByCardCredentialsRequest(
            100,
            Currency::UAH,
