...
class GetEmployeeListSuccessTest extends BaseClientTestCase
{
    public function test(): void
    {
        ...
        $this->requestFactory
            ...
            ->with('GET', 'https://api.monobank.ua/api/merchant/employee/list')
            ->willReturn($httpRequest);
        ...
        $response = $this->client->getEmployeeList();
