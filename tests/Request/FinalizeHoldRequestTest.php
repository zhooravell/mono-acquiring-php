...
class FinalizeHoldRequestTest extends TestCase
{
    ...
    public function testEmptyInvoiceId($value): void
    {
        ...
        new FinalizeHoldRequest($value, 123);
    }

    public function testMinData(): void
    {
        $id = '123456789';
        $amount = 100;
        $request = new FinalizeHoldRequest($id, $amount);

        self::assertEquals(
            ['invoiceId' => $id, 'amount' => $amount],
            $request->getPayload(),
        );
    }
